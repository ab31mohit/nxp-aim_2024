...
class LineFollower(Node):
    ...
    def edge_vectors_callback(self, msg):
        ...
        if self.edgeVectors_topic_pub_count % 3 == 0:
            ...
            if self.ramp_stage == "flat" or self.ramp_stage == "none":
                ...
                # print(f"On or approaching ramp, maintaining speed at {speed}")
            ...
            if (vectors.vector_count == 1):  # curve.
                ...
                if not math.isinf(slope):
                    ...
                    turn = (slope/abs(slope))*del_theta
                else:
                    top_x = half_width
    ...
    def lidar_callback(self, msg):
        ...
        front_ranges = msg.ranges[177:184]  # Adjust indices based on your LIDAR setup
        # print(front_ranges)
