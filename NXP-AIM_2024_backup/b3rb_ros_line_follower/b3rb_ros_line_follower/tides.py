...
class LineFollower(Node):
    ...
    def edge_vectors_callback(self, msg):
        ...
        if self.edgeVectors_topic_pub_count % 3 == 0:
            ...
            if (vectors.vector_count == 1):  # curve.
                ...
                turn = (slope/abs(slope))*slope_angle + self.var
    ...
    def lidar_callback(self, msg):
        ...
        left_obst_ranges = msg.ranges[180:195]
        right_obst_ranges = msg.ranges[180:164:-1]
        sum_left = sum(r for r in left_obst_ranges if not math.isinf(r))
        sum_right = sum(r for r in right_obst_ranges if not math.isinf(r))
